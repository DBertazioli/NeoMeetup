...
def main():
        ...
        for z in grouper(member_df.itertuples(),3): #groups
            ...
            try:    
                ...
                print e
            time.sleep(0.2) #PLS U NO BAN me
            offset += 1
            ...
            if debug_count:
                if count is 50000:
                    ...
                    print "csv printed at iteration" + str(tot_count*3)
                    member_df.to_csv("../Csv/member_enriched.csv")
                    count=0
            
        print member_df.head()
        print "exporting to csv"
        member_df.to_csv("../Csv/member_enriched_final.csv") #prolly never reach here sadly but we always hope that member_enriched_final.csv will be identical to member_enriched.csv, that would be mad&amazing
...
def get_results(params, tot_count, n):
    ...
    try:
        ...
        print "internal exception at the "+ str(tot_count+n) + "iteration"
        pass
